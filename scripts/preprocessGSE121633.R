...
## Load phenotypes ####
gse121633.full <- getGEO("GSE121633")

pheno  <- data.frame(Sample_Name = gse121633.full[[1]]$geo_accession ,
                     Sex =  gse121633.full[[1]]$`Sex:ch1`, 
                     Age = as.numeric(gse121633.full[[1]]$`age:ch1`))
rownames(pheno) <- pheno$Sample_Name


## Create samplesheet
samplesheet <- meffil.create.samplesheet(path = "data/GSE121633/")
...
dir.create("results/preprocess/GSE121633/")
  
outPrefix <- "results/preprocess/GSE121633/GSE121633"
