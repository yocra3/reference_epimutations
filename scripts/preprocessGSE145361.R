...
## Load phenotypes ####
gse145361.full <- getGEO("GSE145361")

pheno  <- data.frame(Sample_Name = gse145361.full[[1]]$geo_accession ,
                     Disease = gse145361.full[[1]]$`disease-state:ch1`,
                     Sex =  gse145361.full[[1]]$`gender:ch1`)
...
## Create samplesheet
samplesheet <- meffil.create.samplesheet(path = "data/GSE145361/")
...
dir.create("results/preprocess/GSE145361/")
  
outPrefix <- "results/preprocess/GSE145361/GSE145361"
...
batch_var <- c("Slide", "sentrix_col",  "sentrix_row", "Sex", "Disease")
